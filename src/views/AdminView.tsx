...
const EMPTY_MONSTER: MonsterRow = { name: '', description: '', minLevel: 1, maxLevel: 6, basePower: 8, baseHp: 90, dropItemName: 'Monster Core', dropChance: 0.7, enabled: 1 };
      ...
      <div className="min-h-screen bg-slate-950 text-white flex items-center justify-center p-6">
        <div className="w-full max-w-md rounded-3xl border border-slate-800 bg-slate-900/90 p-8 shadow-2xl">
          ...
          <div className="space-y-3">
            ...
            <Field label="入口码" value={entryCode} onChange={setEntryCode} type="password" placeholder="ADMIN_ENTRY_CODE" />
